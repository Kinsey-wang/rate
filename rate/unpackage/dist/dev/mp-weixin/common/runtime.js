...
/******/ 		var cssChunks = {"components/rate/uni-rate":1,"components/rate/font-rate/uni-icon":1};
/******/ 		if(installedCssChunks[chunkId]) promises.push(installedCssChunks[chunkId]);
/******/ 		else if(installedCssChunks[chunkId] !== 0 && cssChunks[chunkId]) {
/******/ 			promises.push(installedCssChunks[chunkId] = new Promise(function(resolve, reject) {
/******/ 				var href = "" + ({"components/rate/uni-rate":"components/rate/uni-rate","components/rate/font-rate/uni-icon":"components/rate/font-rate/uni-icon"}[chunkId]||chunkId) + ".wxss";
